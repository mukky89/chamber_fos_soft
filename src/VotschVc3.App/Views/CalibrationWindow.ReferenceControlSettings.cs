...
public partial class CalibrationWindow
{
    ...
    private void InjectReferenceControlSettings()
    {
        ...
        body.Children.Add(new TextBlock
        {
            Text = "Predvolene vypnuté: profil zapisuje cieľ priamo ako setpoint komory. Po ručnom zapnutí sa počas kalibračného plata setpoint komory pomaly a obmedzene koriguje podľa odchýlky WIKA. Stabilitu stále určuje iba WIKA referencia a následne každý FBG peak.",
